...
// Implementing Super Mastermind (a.k.a. Deluxe Mastermind; a.k.a. Advanced Mastermind)
// 8 colors, 5 holes, 12 guesses
// Based on referenced github link by enu-kuro user
...
template MastermindVariation() {
  ...
  // Create a constraint that the solution and guess digits (that represent colors) are all less than 8.
  for (j=0; j<5; j++) {
